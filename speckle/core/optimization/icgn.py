...
def compute_icgn(
    ...
    return _compute_icgn_numba(
        ...
        enable_variable_subset, enable_adss_subset, max_recovery_passes,
    )
...
def _compute_icgn_numba(
    ...
    enable_variable_subset=False, enable_adss_subset=True,
    ...
    if enable_adss_subset:
        ...
        adss_result_obj = compute_adss_recalc(
            ref_gray, grad_x, grad_y,
            coeffs, interpolation_order,
